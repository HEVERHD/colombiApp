...
import ReactImg from '../../../../src/assets/images/avatars/1.jpg'
          ...
          <CCardBody>
            ...
            <DocsExample href="components/carousel">
              <CCarousel>
                ...
                <CCarouselItem>
                  <img className="d-block w-100" src={ReactImg} alt="slide 2" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-100" src={ReactImg} alt="slide 3" />
                </CCarouselItem>
              </CCarousel>
            </DocsExample>
          </CCardBody>
